...
import { FaHome, FaCube, FaColumns, FaMicrophone, FaShapes, FaCalculator, FaRuler, FaKey, FaMouse, FaList, FaUserPlus, FaShoppingCart, FaDice, FaStar } from "react-icons/fa";
...
const exerciseItems: SidebarItem[] = [
  ...
  { label: "Números Aleatorios", route: "/randomnumber", icon: <FaDice /> },
